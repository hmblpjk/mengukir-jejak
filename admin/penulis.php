        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <i class="bi bi-person-fill"></i>
              <button class="btn btn-primary" name="btn_penulis_baru" id="btn_penulis_baru" data-bs-toggle="modal"
                data-bs-target="#modalFormPenulis">Penulis Baru</button>
            </div>
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT id, username, email FROM penulis order by id desc";
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-primary" name="btn_ubah_penulis" data-bs-toggle="modal"
                            data-bs-target="#modalUbahPenulis<?php echo $data_id_penulis; ?>">Ubah</button>
                      ...
                      <div class="modal fade" data-bs-backdrop="static"
                        id="modalUbahPenulis<?php echo $data_id_penulis; ?>">
                            ...
                            <div class="modal-body">
                              <form method="post">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" id="nama" value="<?php echo $data_nama; ?>"
                                    name="nama">
                                </div>
                                <div class="mb-3">
                                  <label for="email" class="form-label">Email:</label>
                                  <input type="email" class="form-control" id="email" value="<?php echo $data_email; ?>"
                                    name="email">
                                </div>
                                <input type="hidden" name="id_penulis" value="<?php echo $data_id_penulis; ?>">
                                <div class="mb-3">
                                  <label for="password" class="form-label">Password:</label>
                                  <input type="password" class="form-control" id="password" placeholder="Isi dengan password lama atau yang baru jika ingin mengubahnya"
                                    name="password">
                                </div>
                          ...
                          <div class="modal-content">
                            ...
                            <form method="post">
                              <div class="modal-body mb-3">
                                Apakah Anda yakin ingin menghapus penulis <strong><?php echo $data_nama; ?></strong>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post">
            ...
            <div class="mb-3">
              <label for="password" class="form-label">Password:</label>
              <input type="password" class="form-control" id="password" placeholder="Masukkan password penulis..." name="password">
            </div>
            <div class="d-flex justify-content-end gap-2">
