      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Silakan kelola kategori</li>
          </ol>
          <div class="card mb-4">
            <div class="card-header">
              <i class="bi bi-bookmark-check-fill"></i>
              <button class="btn btn-primary" name="btn_kategori_baru" id="btn_kategori_baru" data-bs-toggle="modal"
                data-bs-target="#modalFormKategori">Kategori Baru</button>
            </div>
            <div class="card-body">
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-primary" name="btn_ubah_kategori" data-bs-toggle="modal"
                            data-bs-target="#modalUbahKategori<?php echo $data_id_kategori; ?>">Ubah</button>
                      ...
                      <div class="modal fade" data-bs-backdrop="static"
                        id="modalUbahKategori<?php echo $data_id_kategori; ?>">
                              ...
                              <form method="post">
                                ...
                                <div class="mb-3">
                                  ...
                                  <textarea class="form-control" rows="5" id="keterangan" name="keterangan"
                                    placeholder="Masukkan keterangan..."><?php echo $data_keterangan; ?></textarea>
                                </div>
                          ...
                          <div class="modal-content">
                            ...
                            <form method="post">
                              <div class="modal-body mb-3">
                                Apakah Anda yakin ingin menghapus kategori <strong><?php echo $data_nama; ?></strong>
