    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                ...
                <p class="lead mb-0">Blog tentang wisata yang menyenangkan</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        ?>
                        <div class="card mb-4">
                            <a href="detail.php?id=<?php echo $data_id_kontributor; ?>&id_kategori=<?php echo $data_idkategori; ?>"><img class="card-img-top" src="admin/<?php echo $data_gambar; ?>" alt="..." /></a>
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary" href="detail.php?id=<?php echo $data_id_kontributor; ?>&id_kategori=<?php echo $data_idkategori; ?>">Selengkapnya →</a>
                            </div>
                        </div>
                        <?php
                    }
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body tentang">Sekedar buah tangan untuk mengisi waktu luang dengan tulisan-tulisan
                        yang menarik dan informatif. Silakan <a href="#!">hubungi kami</a> jika ada pertanyaan.</div>
                </div>
            </div>
        </div>
    </div>
